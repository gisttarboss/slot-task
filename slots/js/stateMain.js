var StateMain = {
    preload: function() {
        game.load.image("bars", "images/strip3.png");
        game.load.image("btnSpin", "images/btnSpin3.png");
    },
    create: function() {
        ...
        //
        for (var i = 0; i < 3; i++) {
            var bar = game.add.sprite(i * 100, 0, "bars");
        ...
        //add spin button
        //
        this.btnSpin = game.add.sprite(game.width / 2, game.height * .75, "btnSpin");
    ...
    startSpin() {
        ...
        var s1 = game.rnd.integerInRange(1, 6);
        var s2 = game.rnd.integerInRange(1, 6);
        var s3 = game.rnd.integerInRange(1, 6);
